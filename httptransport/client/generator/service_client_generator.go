	...
	g.File.WriteBlock(
		codegen.DeclType(
			codegen.Var(codegen.Struct(
				codegen.Var(codegen.Type(g.File.Use("github.com/liucxer/courier/courier", "Client")), "Client"),
...
func (g *ServiceClientGenerator) OperationMethod(ctx context.Context, operation *oas.Operation, asInterface bool) codegen.Snippet {
	...
	params = append(params, codegen.Var(codegen.Ellipsis(codegen.Type(g.File.Use("github.com/liucxer/courier/courier", "Metadata"))), "metas"))
