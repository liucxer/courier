...
func TestPackage(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			[][]string{
				{"interface{}"},
				{"github.com/liucxer/courier/packagesx/__fixtures__.String"},
			},
		},
		{
			"FuncCallWithFuncLit",
			[][]string{
				{"interface{}"},
				{"github.com/liucxer/courier/packagesx/__fixtures__.String(\"1\")"},
			},
		},
		{
			"FuncSingleReturn",
		...
		},
		{
			...
			[][]string{
				{`untyped string("1")`},
				{`github.com/liucxer/courier/packagesx/__fixtures__.String("2")`},
			},
		},
		{
			"FunWithSwitch",
			[][]string{
				...
				{
					`github.com/liucxer/courier/packagesx/__fixtures__.String("b1")`,
					`github.com/liucxer/courier/packagesx/__fixtures__.String("b2")`,
					`github.com/liucxer/courier/packagesx/__fixtures__.String("b3")`,
				},
			},
		},
		{
